        ...
        >
            <a-row :gutter="24">
                <a-col :span="20" v-show="!!warehouse">
                    <a-form-item label="子模块编码">
                        <a-input
                            v-decorator="[`sub_model_code`]"
                            placeholder="子模块编码"
                            size="small"
                            style="width: 200px;"
                            :disabled="!!warehouse"
                ...
                <a-col :span="20">
                    <a-form-item label="子模块名称" required>
                        <a-input
                            v-decorator="[
                                `sub_model_name`,
                                {
...
export default class AddSubMoule extends Vue {
    @Emit('modal.submit')
    private submit() {
        return true
    }
    ...
    private onSubmit() {
        this.form.validateFields({}, (err, values) => {
            if (!err) {
                ...
                values['status'] = 20
                values['model_code'] = this.model_code
