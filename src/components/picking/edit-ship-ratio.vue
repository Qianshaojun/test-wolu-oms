<template>
    <section class="component order-base-detail">
        ...
        >
            ...
            <a-row :gutter="24" style="margin-top:30px;margin-bottom:20px;">
...
export default class EditShipRatio extends Vue {
    @Emit('modal.submit')
    private submit() {
        return [this.data]
    }
    ...
    private onInfoChange() {
        ...
        this.defaultPriceCalcType = this.data.is_dynamic_calculation
            ? 'open'
            : 'close'
        this.setFormValues()
    }
