<template>
    <section class="component edit-customer">
        ...
        >
            <a-row :gutter="24">
                <a-col :span="30">
                    <a-form-item :label="$t('columns.manual_code')">
                        <a-input
                            v-decorator="[
                                'manual_code',
                                {
                ...
                <a-col :span="30">
                    <a-form-item :label="$t('columns.manual_url')">
                        <a-input
                            v-decorator="[
                                'manual_url',
                                {
                ...
                <a-col :span="30">
                    <a-form-item :label="$t('columns.manual_version')" required>
                        <a-select
                ...
                <a-col :span="30">
                    <a-form-item :label="$t('columns.doc_code')">
                        <a-input
                            v-decorator="[
                                'doc_code',
                                {
                ...
                <a-col :span="30">
                    <a-form-item :label="$t('columns.z_sub_category')" required>
                        <a-select
...
export default class ManualEdit extends Vue {
    @Emit('modal.submit')
    private submit() {
        return true
    }
