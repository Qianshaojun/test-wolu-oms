        ...
        >
                ...
                <a-row :gutter="24">
                    <a-col :span="8">
                        <a-form-item label="SKU" required>
                            <a-input
                                v-decorator="['sku', { rules: rules.required }]"
                                size="small"
                            />
                        </a-form-item>
                    </a-col>
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.operator')">
                            <a-input v-decorator="['operator']" size="small" />
                        </a-form-item>
                    </a-col>
                    <a-col :span="8">
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.weight')" required>
                            <a-input-number
                                v-decorator="[
                                    'weight',
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.size1')" required>
                            <a-input-number
                                v-decorator="[
                                    'size1',
                                    { rules: rules.required }
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.size2')" required>
                            <a-input-number
                                v-decorator="[
                                    'size2',
                                    { rules: rules.required }
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.size3')" required>
                            <a-input-number
                                v-decorator="[
                                    'size3',
                                    { rules: rules.required }
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.pack_num')" required>
                            <a-input-number
                                v-decorator="[
                                    'pack_num',
                                    { rules: rules.required }
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.girth')" required>
                            <a-input-number
                                v-decorator="[
                                    'girth',
                                    { rules: rules.required }
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.volume')" required>
                            <a-input-number
                                v-decorator="[
                                    'volume',
                                    { rules: rules.required }
            ...
            <a-card style="margin-top:5px;">
                ...
                <a-row :gutter="24">
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.money_type')" required>
                            <a-select
                                v-decorator="[
                                    'money_type',
                                    { rules: rules.required }
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.refund_tax')" required>
                            <a-input-number
                                v-decorator="[
                                    'refund_tax',
                                    { rules: rules.required }
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.ero_to_cn')" required>
                            <a-input-number
                                v-decorator="[
                                    'ero_to_cn',
                                    { rules: rules.required }
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.custom_tax')" required>
                            <a-input-number
                                v-decorator="[
                                    'custom_tax',
                                    { rules: rules.required }
                    ...
                    <a-col :span="8">
                        <a-form-item :label="$t('columns.cost_price')" required>
                            <a-input-number
                                v-decorator="[
                                    'cost_price',
                                    { rules: rules.required }
...
import PreProductPriceCheck from './pre-product-price-check.vue'
...
export default class ProductPriceCheckCreate extends Vue {
    @Emit('modal.submit')
    private submit() {
        return true
    }
    ...
    private saveInfo(param) {
        this.innerAction.setActionAPI(
            'product_management/save_product_price_check_info',
            CommonService.getMenuCode('product_price_check')
        )
        this.publicService
            .modify(
                new RequestParams(param, {
