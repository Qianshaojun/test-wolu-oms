<template>
    <section
        class="page login full-absolute flex-row justify-content-center align-items-center"
    >
        <a-card class="login-form" :title="$t('title')">
            ...
            <a-form :form="form" @submit="onSumbit">
                <a-form-item>
                    <a-input
...
.login {
    background-image: url('~@/assets/images/mobile-login-bg.jpg');
