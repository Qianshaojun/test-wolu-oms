...
import ProductPriceCheckCreate from '~/components/product/product-price-check-create.vue'
...
export default class ProductPriceCheckNew extends Vue {
    @Ref()
