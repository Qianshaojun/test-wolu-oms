    ...
    <page-container ref="pageContainer" :showHeader="false">
        ...
        >
            <pane max-size="30">
                ...
                <data-form
                    ref="dataForm"
                    @submit="getPurchaseReduceCostData"
                    :column="2"
                    :style="{
                    ...
                    <data-table
                        ...
                        :rowSelection="{
                            ...
                            onChange: (keys, select_rows) => {
                                ...
                                this.showReduceCostChart(select_rows)
                            }
                        }"
                        :columns="columnList"
                        @on-page-change="getPurchaseReduceCostData"
                        @onClick="
                            row => {
                                ...
                                this.showReduceCostChart(curRow)
                            }
                        "
            ...
            <pane min-size="20">
                <a-card title="趋势图" :style="{ height: panel3Height }">
                    <ve-line :data="reduceCostCharData"></ve-line>
                </a-card>
            </pane>
        </splitpanes>
    </page-container>
...
export default class PurchaseReduceCostReport extends Vue {
    // 表格组件
    @Ref()
    ...
    private reduceCostCharData: any = []
    private query_type: String = 'year'

    private showReduceCostChart(selectedRows) {
        let row_list: any[] = []
                ...
                for (let column_index in this.columnList) {
                    ...
                    if (column_info.children) {
                        for (let children_index in column_info.children) {
                            ...
                            this.reduceCostCharData.rows[cell_index][
                                default_code
                            ] = row[columnName]
                        ...
                        this.reduceCostCharData.rows[column_index][
                            default_code
                        ] = row[columnName]
    ...
    private getPurchaseReduceCostData() {
        this.columnList = this.getBasicColumnInfo()
            ...
            for (let season_index in season_list) {
                ...
                let column_info = {
                    ...
                    children: [
                        ...
                        {
                            dataIndex:
                                year + '_season_' + season + '_reduce_costs',
            ...
            for (let month_index in month_list) {
                ...
                let column_info = {
                    ...
                    children: [
                        ...
                        {
                            dataIndex:
                                year + '_month_' + month + '_reduce_costs',
    ...
    private exportData() {
        this.getQueryCondition().then((x: any) => {
            CommonService.exportData(
                '/purchase_requirement/export_purchase_reduce_costs_report',
