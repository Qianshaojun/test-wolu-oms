            ...
            <section class="component edit-customer">
                ...
                >
                    ...
                    <a-row :gutter="24">
                        <a-card>
                            <h3
                                style="margin-top:10px;color:#000;font-weight:600;"
                            >
                            ...
                            <a-col :span="12">
                                <a-form-item :label="$t('columns.vendor_code')">
                                    <a-input
                                        v-decorator="[`vendor_code`,{initialValue: vendorCode }]"
                                        size="small"
                                        :disabled="true"
                                    />
                                </a-form-item>
                            ...
                            <a-col :span="12">
                                <a-form-item
                                    :label="$t('columns.company_address')"
                                >
                                    <a-input
                            ...
                            <a-col :span="12">
                                <a-form-item
                                    :label="$t('columns.com_license_url')"
                                >
                                    <a
                                        @click="
                                            downloadLicense(
                                                vendor.com_license_url
                                            )
                                        "
                        ...
                        <a-card>
                            ...
                            <a-col :span="12">
                                <a-form-item
                                    :label="$t('columns.contract_email')"
                                >
                                    <a-input
                            ...
                            <a-col :span="12">
                                <a-form-item
                                    :label="$t('columns.contract_phone')"
                                >
                                    <a-input
                        ...
                        <a-card>
                            ...
                            <a-col :span="12">
                                <a-form-item
                                    :label="$t('columns.bank_account_no')"
                                >
                                    <a-input
                        ...
                        <a-card>
                            ...
                            <a-col :span="12">
                                <a-form-item
                                    :label="$t('columns.schedule_cycle')"
                                >
                                    <a-input-number
                                ...
                                .subscribe(
                                    data => {
                                        ...
                                        if (this.save_flag === 0) {
                                            ...
                                            vls.vendor_code = this.vendor.vendor_code
                                            this.vendorCode = this.vendor.vendor_code
                                        }
                                        vls.write_date = moment(new Date())
