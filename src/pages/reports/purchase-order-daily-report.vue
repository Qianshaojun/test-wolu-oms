            ...
            <template #default>
                ...
                >
                    <a-select
                        ...
                        size="small"
                    >
                        <a-select-option value="order_name">
                            {{ $t('columns.order_id') }}
                        </a-select-option>
                        <a-select-option value="real_pre_purchase_order">
                            {{ $t('columns.contact_no') }}
                        </a-select-option>
...
export default class PurchaseOrderDailyReport extends Vue {
    // 表格组件
    // 表格组件
    @Ref()
    ...
    private queryUrl: any = 'report_management/query_all_make_order_daily_info'
