            ...
            <template #default>
                ...
                >
                    <a-select
                        ...
                        size="small"
                    >
                        <a-select-option value="order2_name">
                            {{ $t('columns.order_id') }}
                        </a-select-option>
                        <a-select-option value="out_number">
...
export default class ShipOrderDailyReport extends Vue {
    // 表格组件
    // 表格组件
    @Ref()
    ...
    private queryUrl: any =
        'report_management/query_all_ship_order_daily_report'
