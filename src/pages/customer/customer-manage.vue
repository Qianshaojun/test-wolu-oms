    ...
    <page-container ref="pageContainer">
        ...
        >
            ...
            <template #default>
                ...
                <a-form-item label="贷代" style="height:35px;margin:0;">
                    <a-radio-group
                        v-decorator="[
        ...
        <a-card class="margin-y">
            ...
            >
                ...
                <a-table-column
                    :title="$t('columns.is_shipment_provider')"
                    dataIndex="is_shipment_provider"
                    key="is_shipment_provider"
                    align="center"
                    width="10%"
                >
                    <template slot-scope="is_shipment_provider">
                        <span v-if="is_shipment_provider"
                ...
                >
                    <template slot-scope="status">
                        ...
                        <span v-else-if="status == 20" style="color:gray;">{{
                            status | dict('CustomerStatus') | translate
                        }}</span>
                        <span v-else-if="status == 30" style="color:#333;">{{
                            status | dict('CustomerStatus') | translate
                        }}</span>
                        <span v-else-if="status == 40" style="color:red;">{{
                            status | dict('CustomerStatus') | translate
                        }}</span>
...
<i18n>
{
  "en-us": {
    ...
    "columns":{
      ...
      "is_shipment_provider":"Shipment Provider"
    },
    "form":{
       "status":"Status",
